...
regressor.add(LSTM(units = 400, return_sequences = True, input_shape = (previsores.shape[1], quantidadePrevisores)))
...
es = EarlyStopping(monitor = 'loss', min_delta = 1e-10, patience = 50, verbose = 1)
